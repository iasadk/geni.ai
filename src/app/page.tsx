    ...
    <>
      <Container className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Geni.ai allows you to have conversations with any PDF document. Simply
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        ...
        {/* steps */}
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0 md:px-2">
