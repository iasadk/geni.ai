                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      {
                        'border-2 border-rose-600 shadow-rose-200':
                          plan === 'Pro',
                    ...
                    {plan === 'Pro' && (
                      <div className='absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-red-600 to-rose-500 px-3 py-2 text-sm font-medium text-white'>
                        Upgrade now
                      </div>
                    )}
                    ...
                    <div className='p-5'>
                      {plan === 'Free' ? (
                        <Link
                          href={
                            user ? '/dashboard' : '/api/auth/register?origin=pricing'
                          }
                        ...
                        <Link
                          href='/api/auth/register?origin=pricing'
                          className={buttonVariants({
                            className: 'w-full',
                          })}>
                          {user ? 'Upgrade now' : 'Sign up'}
